...
public class UserLocationActivity extends Activity implements GoogleApiClient.ConnectionCallbacks,
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mAppPreferences=new AppPreferences(UserLocationActivity.this);
        Init();
    ...
    public void onLocationChanged(Location location) {
        ...
        if (mylocation != null) {
            ...
            try {
                ...
                mAppPreferences.setLat(latitude);
                mAppPreferences.setLong(longitude);
            } catch (IOException e) {
                e.printStackTrace();
            }
            if(addressList!=null)
            {
                ...
                if(locationflag == 0)
                {
                    ...
                    if(className == "" || className == null)
                    {
                        ...
                        mAppPreferences.setUserLocation(address.getAddressLine(0));
                        Intent intent=new Intent(UserLocationActivity.this, BasicInfo.class);
                    ...
                    else
                    {
                        ...
                        mAppPreferences.setUserLocation(address.getAddressLine(0));
                        Intent intent=new Intent(UserLocationActivity.this, AppConstants.classMap.get(className));
                        startActivity(intent);
                        locationflag = 1;
                        finish();
                    }
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            try {
                ...
                if (addressList != null && addressList.size() > 0) {
                    Address address = addressList.get(0);
                    mAppPreferences.setLat(address.getLatitude());
                    mAppPreferences.setLong(address.getLongitude());
                }
            } catch (IOException e) {
                e.printStackTrace();
            }
            ...
            {
                mAppPreferences.setLoginState(1);
                Intent intent = new Intent(con, BasicInfo.class);
                mAppPreferences.setUserLocation(address);
                startActivity(intent);
                finish();
            }
            else
